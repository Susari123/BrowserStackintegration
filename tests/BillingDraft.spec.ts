...
if (suggestionVisible) {
  ...
  throw new Error('❌ ICD suggestion list did not appear after retries.');
    ...
    // ===================== SUBMIT =====================
    const DraftButton = page.locator("//sl-button[contains(text(),'Save as Draft')]");
    ...
    await BrowserStackHelper.markTestStatus(page, 'passed', 'Billing draft claim generated successfully');
  } catch (err: any) {
